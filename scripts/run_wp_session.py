...
def run_once(
    ...
    *,
    ...
    if (
        ...
        print("WP V8 uses the frozen 14:50 feature snapshot for close-state rendering.")
    else:
        print("::warning::WP V8 live source is absent before the signal window.")
    manifest_path = Path("outputs/json/wp_manifest.json")
