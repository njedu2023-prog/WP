...
- 统计校准：当 `outputs/backtests/*/trades.csv` 历史样本足够时，会按概率分层命中率对 `p_limitup_t1` 做轻量校准，并输出 `p_limitup_t1_raw`、`calibration_sample_count`、`self_learning_adjustment`。
