...
def test_tail_window_has_one_shared_generation_boundary():
    ...
    assert tail_window_phase("2026-07-24 14:50:59") == TAIL_PHASE_ACTIVE
    assert tail_window_phase("2026-07-24 14:51:00") == TAIL_PHASE_FROZEN
    assert tail_window_phase("2026-07-24 14:55:00") == TAIL_PHASE_FROZEN
